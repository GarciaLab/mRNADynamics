...
%%%%%%% Calculate the amount of Cytoplasmic mRNA present
 ...
 Blkk=[]; % Matrix of length number of particles by number time points where the accumulated amount is calulated
 ...
 save([DropboxFolder,filesep,Prefix,filesep,'AccumulationData-',num2str(halflife),'min.mat'],'Blk','Blkk','HGDotstoJBNucs');
