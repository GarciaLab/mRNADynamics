function CompileParticlesOld(varargin)
...
if strcmp(Txt(XLSEntry,Channel2Column),'His-RFP')
    nc9=Num(XLSEntry,nc9Column);
    nc10=Num(XLSEntry,nc10Column);
    nc11=Num(XLSEntry,nc11Column);
    nc12=Num(XLSEntry,nc12Column);
    nc13=Num(XLSEntry,nc13Column);
    nc14=Num(XLSEntry,nc14Column);
    %This is in case the last column for CF is all nan and is not part of
    %the Num matrix
    if size(Num,2)==CFColumn    
        CF=Num(XLSEntry,CFColumn);
    else
        CF=nan;
    end
else
