...
[Prefix, SkipFrames, ProjectionType, PreferredFileForTest] = exportDataForFISH_processInputParameters(varargin{:})
...
elseif strcmp(FileMode,'LIFExport')
  FrameInfo = processLIFExportMode(Folder, ExperimentType, FrameInfo, ProjectionType, Channel1, Channel2, Channel3, Prefix, OutputFolder, PreferredFileForTest);        
