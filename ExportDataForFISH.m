...
[NIndices, MaxShift, MaxHistone, ProjectionType, PrefixOverrideFlag, SkipFrames] = ExportDataForFISH_processArguments(varargin);

[SourcePath,FISHPath,DropboxFolder,MS2CodePath, PreProcPath,...
    Folder, Prefix, ExperimentType, Channel1, Channel2,OutputFolder...
    ] = readMovieDatabase(PrefixOverrideFlag);

[D, FileMode, DTIF, DLSM, DLIF, DCZI, DLAT, DSPIN, DND2] = ExportDataForFISH_determineFileMode(Folder);
...
elseif strcmp(FileMode,'LIFExport')
    ...
    ExportDataForFISH_processLIFExportFileMode(Prefix, Folder, DLIF, ProjectionType, ExperimentType, Channel1, Channel2, OutputFolder);
