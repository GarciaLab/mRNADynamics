...
function txt = InstallmRNADynamics
  ...
  function createMovieDatabaseFile()
    movieDatabaseInstallationFile = 'InstallationFiles/InstallMovieDatabase.xlsx'
    movieDatabaseFile = [DYNAMICS_RESULTS_PATH, '/MovieDatabase.xlsx']

    copyFileIfNotExists(movieDatabaseInstallationFile, movieDatabaseFile)
  end

  function contents = createFoldersConfig_CSV()
    configFile = [ROOT_PATH, '/ComputerFolders.csv'];
    if exist(configFile)
  ...
  function txt = createComputerFoldersConfig()
    computerFoldersInstallationFile = 'InstallationFiles/InstallComputerFolders.xlsx';
    computerFoldersFile = [ROOT_PATH, '/ComputerFolders.xlsx'];
