function [ trackingStartingPoints ] = choseFramesToStartTracking( indMitosis, numberOfFrames )
...
delta_time_tracking = getDefaultParameters('delta t','choseFramesToStartTracking')/time_resolution;
