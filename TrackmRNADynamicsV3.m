function [Particles,schnitzcells,fad,fad2]=TrackmRNADynamicsV3(varargin)
...
for i=1:length(fad.channels)
    ...
    %If we do have the histone channel    
        ...
        [Particles,fad,fad2,schnitzcells]=AssignParticle2NucleusV4(schnitzcells,Ellipses,Particles,fad,fad2,...
            ...
            for k=1:length(ParticlesInNucleus)
                ...
                if CheckParticle
                    ...
                    while (CurrentParticleLength<length(Particles(CurrentParticle).Frame))&...
                        ...
                        [fad,fad2,Particles] = ConnectToThresholdHistoneV3(fad,fad2,Particles,...
                    ...
                    while (CurrentParticleLength<length(Particles(CurrentParticle).Frame))&...
                        ...
                        [fad,fad2,Particles] = ConnectToThresholdHistoneV2(fad,fad2,Particles,...
                            CurrentParticle,CurrentFrame,CurrentFrame-1,schnitzcells,Ellipses,SearchRadius,...
                            PixelSize);
                    end
