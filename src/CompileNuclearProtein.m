...
if strcmpi(ExperimentAxis,'dv') || strcmpi(ExperimentAxis,'apdv')
    ...
    %Divide the DV axis into boxes of a certain AP size. We'll see which
    %particle falls where.
...
if strcmpi(ExperimentAxis,'ap') || strcmpi(ExperimentAxis,'apdv')   %JAKE
    %When you are changing this code, please change "DV" version
    %accordingly
...
if strcmpi(ExperimentAxis,'ap')
    ...
    if ROI
        save([DropboxFolder,filesep,Prefix,filesep,'CompiledNuclei.mat'],...
            'CompiledNuclei','ElapsedTime','NewCyclePos','nc9','nc10','nc11',...
            'nc12','nc13','nc14','ncFilterID','ncFilter','DVbinID','DVFilter',...
            'MeanVectorDV','SDVectorDV','NParticlesDV',...
            'MeanVectorAll','SDVectorAll','NParticlesAll',...
            'MeanVectorAll_ROI','SDVectorAll_ROI','NParticlesAll_ROI',...
            'MeanVectorAll_nonROI','SDVectorAll_nonROI','NParticlesAll_nonROI',...
            'MaxFrame','MinDVIndex','MaxDVIndex',...
            'AllTracesVector','AllTracesDV',...
            'MeanCyto','SDCyto','MedianCyto','MaxCyto',...
            'MeanVectorDV_ROI','SDVectorDV_ROI','NParticlesDV_ROI',...
        ...
        save([DropboxFolder,filesep,Prefix,filesep,'CompiledNuclei.mat'],...
            'CompiledNuclei','ElapsedTime','NewCyclePos','nc9','nc10','nc11',...
            'nc12','nc13','nc14','ncFilterID','ncFilter','DVbinID','DVFilter',...
            'MeanVectorDV','SDVectorDV','NParticlesDV','MeanVectorAll',...
            'SDVectorAll','NParticlesAll','MaxFrame','MinDVIndex','MaxDVIndex',...
            'AllTracesVector','AllTracesDV',...
            'MeanCyto','SDCyto','MedianCyto','MaxCyto','-v7.3')%,...
            %'IntegrationArea')
    end
else if strcmpi(ExperimentAxis,'apdv')
    if ROI
        save([DropboxFolder,filesep,Prefix,filesep,'CompiledNuclei.mat'],...
            'CompiledNuclei','ElapsedTime','NewCyclePos','nc9','nc10','nc11',...
            'nc12','nc13','nc14','ncFilterID','ncFilter','APbinID','DVbinID','APFilter',...
            'DVFilter','MeanVectorAP','MeanVectorDV','SDVectorAP','SDVectorDV','NParticlesAP',...
            'NParticlesDV','MeanVectorAll','SDVectorAll','NParticlesAll',...
            'MeanVectorAll_ROI','SDVectorAll_ROI','NParticlesAll_ROI',...
            'MeanVectorAll_nonROI','SDVectorAll_nonROI','NParticlesAll_nonROI',...
            'MaxFrame','MinAPIndex','MinDVIndex','MaxAPIndex','MaxDVIndex',...
            'AllTracesVector','AllTracesAP','AllTracesDV',...
            'MeanCyto','SDCyto','MedianCyto','MaxCyto',...
            'MeanCytoAPProfile','SDCytoAPProfile','SECytoAPProfile',... 
            'MeanVectorAP_ROI','SDVectorAP_ROI','NParticlesAP_ROI',...
            'MeanVectorDV_ROI','SDVectorDV_ROI','NParticlesDV_ROI',...
        ...
        save([DropboxFolder,filesep,Prefix,filesep,'CompiledNuclei.mat'],...
            ...
            'nc12','nc13','nc14','ncFilterID','ncFilter','APbinID','DVbinID','APFilter',...
            'DVFilter','MeanVectorAP','MeanVectorDV','SDVectorAP','SDVectorDV','NParticlesAP',...
            'NParticleDV','MeanVectorAll','SDVectorAll','NParticlesAll','MaxFrame','MinAPIndex',...
            'MeanDVIndex','MaxAPIndex','MaxDVIndex','AllTracesVector','AllTracesAP','AllTracesDV',...
            'MeanCyto','SDCyto','MedianCyto','MaxCyto','MeanCytoAPProfile','SDCytoAPProfile',...
            'MeanCytoAPProfile','SDCytoAPProfile','SECytoAPProfile',...
            'SECytoAPProfile', '-v7.3')%,...
            %'IntegrationArea')
    end       
    else
        save([DropboxFolder,filesep,Prefix,filesep,'CompiledNuclei.mat'],...
