...
[sortByFrames, sortByLength, ForCompileAll, SpeedMode, ~, ...
    ...
    noHisOverlay, multiView, preStructs, preMovie, UseCompiledParticles, useProjectionInHistoneOverlay, displayOnlyCurrentZEllipses] = determineCheckParticleTrackingOptions(varargin{:});
...
cptState.displayOnlyCurrentZEllipses = displayOnlyCurrentZEllipses;
...
while (currentCharacter ~= 'x')
    ...
    if cptState.UseHistoneOverlay
        ...
        displayOverlays(overlayAxes, cptState, SpeedMode, ShowThreshold2, Overlay, nFrames, UseSchnitz, ZoomRange, fish, subAx,...
            HisOverlayFigAxes, hisImage, useProjectionInHistoneOverlay);
    else
        displayOverlays(overlayAxes, cptState, SpeedMode, ShowThreshold2, Overlay, nFrames, UseSchnitz, ZoomRange, fish, subAx);
    end
