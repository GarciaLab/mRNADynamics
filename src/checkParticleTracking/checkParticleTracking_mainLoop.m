function [cc, Particles, CurrentChannel, Spots, CurrentFrame, CurrentParticle, ManualZFlag, projectionMode, DisplayRangeSpot,...
      ...
      coatChannel, PreviousChannel, PreviousParticle, lastParticle, HideApprovedFlag, lineFitted] =...
  ...
  correspondingNCInfo, Coefficients, zProfileFigAxes, zTraceAxes, frame_num, z_num, particle_num, CurrentZ)
