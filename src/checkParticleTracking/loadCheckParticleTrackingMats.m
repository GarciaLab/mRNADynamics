...
function [Particles, SpotFilter, Spots, FrameInfo, Spots3D] = loadCheckParticleTrackingMats(DataFolder, PreProcPath, fish)
    ...
    if exist([DataFolder, filesep, 'Spots3D.mat'], 'file') & ~fish
