...
function [Channels, ProjectionType, hisMat] = chooseAnaphases(movieMat, varargin)
...
if ~isempty(Prefix)
    ...
    anaphaseTable = uitable(fig, 'Position', [dim(1) * 0.05, dim(2) * 0.2, dim(1) * 0.2, dim(2) * 0.253],...
        ...
