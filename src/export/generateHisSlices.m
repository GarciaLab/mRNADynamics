function nuclearStack = generateHisSlices(images, NSlices, NChannels, fiducialChannel, framesIndex, seriesIndex)

%Leica SP8 data only

% For all 'nuclear' channels, generate HisSlices
nuclearStack = zeros([size(images{seriesIndex}{1, 1}, 1), size(images{seriesIndex}{1, 1}, 2), NSlices(seriesIndex)]);
z = 1;
