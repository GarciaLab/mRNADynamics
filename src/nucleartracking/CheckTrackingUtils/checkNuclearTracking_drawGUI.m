...
if isfield(cntState.FrameInfo, 'nc')
    set(OverlayFig,'Name',['Schnitz Cell: ',num2str(cntState.CurrentNucleus),'/',num2str(cntState.numNuclei()),...
        ...
        ', Ch: ',num2str(cntState.CurrentChannel)])
end
...
firstLine = [Prefix,'    Nucleus: ',num2str(cntState.CurrentNucleus),'/',num2str(numNuclei)];
% STOPPED HERE
secondLine = ['Frame: ',num2str(cntState.CurrentFrame),'/',num2str(numFrames),'    ',num2str(round(ElapsedTime(cntState.CurrentFrame))), 'm'];
