...
for i = 1:length(varargin)
    ...
    elseif strcmpi(varargin{i}, 'nuclearMask')
        error('.\n%s', ...
              'Error: The ''nuclearMask'' = false option is currently not compatible with the parfor loop in segmentTranscriptionalLoci.m (called by segmentSpots) due to an elusive, currently unsolved bug',...
              'It''s been temporarily commented out. To use nuclearMask = true option, do the following:',...
              '(1) In segmentTranscriptionalLoci.m, find the two ''if shouldMaskNuclei'' statements, at approx. lines 95 and 198. Uncomment both these if statements in their entirety',...
              '(2) In determineSegmentSpotsOptions.m, comment out this error message at approx. line 82',...
              '(3) DO NOT push the changes in 1-2 to the master branch. If you need them, please stash on a separate branch',...
