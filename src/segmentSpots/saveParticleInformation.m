    ...
    for zIndex = 1:zSize
      ...
      for spot = 1:length(all_frames{frameIndex, zIndex}) % spots within particular image
        ...
        if ~ isempty(all_frames{frameIndex, zIndex}{spot})
          ...
          Particles(n).Snippet{1} = cell2mat(all_frames{frameIndex, zIndex}{spot}(5));
          ...
          Particles(n).snippet_mask{1} = cell2mat(all_frames{frameIndex, zIndex}{spot}(14));
          ...
          Particles(n).gaussSpot{1} = cell2mat(all_frames{frameIndex, zIndex}{spot}(20));
          ...
          raw = all_frames{frameIndex, zIndex}{spot}(21);
