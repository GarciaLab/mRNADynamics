function [Spots, dogs]...
    = segmentTranscriptionalLoci(channelIndex, initialFrame, lastFrame,...
                                 zSize, ~, Prefix, ~, shouldDisplayFigures, ...
                                 doFF, ffim, Threshold, neighborhood, ...
                                 snippet_size, ~, microscope, ~, ...
                                 filterMovieFlag, resultsFolder, gpu, ...
                                 saveAsMat, ~, shouldMaskNuclei, autoThresh,...
                                 ch_segment)
