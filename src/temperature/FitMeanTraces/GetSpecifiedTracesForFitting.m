function [NCAPtrace, StdErrorTrace, NCTimes] = GetSpecifiedTracesForFitting(this, SetIndex, NC,APindex, TraceType)
% author: G. Martini
...
MeanProfileTraces = this.MeanProfiles{SetIndex}.([traceName, 'CycleMeanTraces']);
