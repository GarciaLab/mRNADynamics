...
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles = {};
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling = {};
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.x = xfits;
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.ControlSet.mean = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.TestSet.mean = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.ControlSet.se = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.TestSet.se = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.ControlSet.counts = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.TestSet.counts = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.ControlSet.counts_above = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.TestSet.counts_above = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.ControlSet.counts_below = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.ControlScaling.TestSet.counts_below = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling = {};
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.x = xfits;
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.ControlSet.mean = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.TestSet.mean = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.ControlSet.se = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.TestSet.se = NaN(Nxfits, NumAPbins, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.ControlSet.counts = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.TestSet.counts = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.ControlSet.counts_above = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.TestSet.counts_above = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.ControlSet.counts_below = NaN(Nxfits, NChannels, NumMasterProfSets);
CompiledEmbryos.BootstrappedUnivScaledProfiles.FitZeroedSlideRescaledDorsalAvgAPProfiles.TestScaling.TestSet.counts_below = NaN(Nxfits, NChannels, NumMasterProfSets);
...
ProfString1s = {'SlideRescaledDorsalAvgAPProfiles', 'ZeroCorrectedSlideRescaledDorsalAvgAPProfiles',...
    'FitSlideRescaledDorsalAvgAPProfiles','FitZeroedSlideRescaledDorsalAvgAPProfiles','HybridRescaledDorsalAvgAPProfiles'};

ProfString2s = {'ControlScaling', 'TestScaling'};
...
for type_index = 1:length(ProfString1s)
    ProfString1 = ProfString1s{type_index};
    for subtype_index = 1:length(ProfString2s)
 
        ProfString2 = ProfString2s{subtype_index};
        if strcmpi(lower(ProfString2), 'testscaling') & ~UseTestScaling
            continue
        end
