...
if ~isfield(CompiledEmbryos.BootstrappedProfiles, 'FitZeroedSlideRescaledDorsalAvgAP')
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP = {};
    CompiledEmbryos.BootstrappedProfiles.FitSlideRescaledDorsalAvgAP.x = {};
    CompiledEmbryos.BootstrappedProfiles.FitSlideRescaledDorsalAvgAP.Test = {};
    CompiledEmbryos.BootstrappedProfiles.FitSlideRescaledDorsalAvgAP.Control = {};
end
...
sigma = 5;
window_multiplier = 3;
NumBootstrappedFits = 200; % switch to 200
NumPoints = 100; % switch to 100
...
%% Bootstrapping the FitZeroedSlideRescaledDorsalAvgAPProfiles for the Test Set

CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.mean = NaN(Nxfits, NumAPbins, NChannels);
CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.se = NaN(Nxfits, NumAPbins, NChannels);

for ch_index = 3
    UseTF = CompiledEmbryos.TestSetEmbryos & CompiledEmbryos.IsNC14 & ~isnan(CompiledEmbryos.DubuisEmbryoTimes);
    x_sample = CompiledEmbryos.DubuisEmbryoTimes(UseTF);
    ys = CompiledEmbryos.FitZeroedSlideRescaledDorsalAvgAPProfiles(UseTF, :,ch_index);
    BadTF =  sum(isnan(ys), 2).' > NumAPbins/2;%min( sum(isnan(ys), 2).');
    x_sample = x_sample(~BadTF);
    ys = ys(~BadTF,:);
    ...
    MeanSmoothedProfiles(MeanSmoothedProfiles  == 0) = NaN;
    %close all
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.x = xfits;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.mean(:,:,ch_index) = MeanSmoothedProfiles;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.se(:,:,ch_index)  = SmoothedProfileSEs;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.counts = counts;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.counts_above = counts_above;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Test.counts_below = counts_above;
...
CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.mean = NaN(Nxfits, NumAPbins, NChannels);
CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.se = NaN(Nxfits, NumAPbins, NChannels);
...
for ch_index = 3
    ...
    %close all
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.x = xfits;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.mean(:,:,ch_index) = MeanSmoothedProfiles;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.se(:,:,ch_index)  = SmoothedProfileSEs;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.counts = counts;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.counts_above = counts_above;
    CompiledEmbryos.BootstrappedProfiles.FitZeroedSlideRescaledDorsalAvgAP.Control.counts_below = counts_above;
