...
GoodTimes = DubuisTimes >= 33 & DubuisTimes <= 38;
...
for i = 1:NSubsets
    ...
    means(~GoodTimes,:,:,i) = NaN;
    counts(~GoodTimes,:,:,i) = 0;
end
...
% 20ºC Flipped Control & 17.5ºC Flipped Control ( can also include 25ºC Rep
% 1 Test & 25C Rep 2 Test)
Ts = [25, 25, 27.5,27.5, 22.5,22.5,20, 17.5, 17.5];
Reps = [0, 2, 1, 2, 1, 2, 2, 1, 2];
...
%%
AllSmoothUnflippedCompiledPath = 'S:/Gabriella/Dropbox/ProteinProfiles/Smoothed25CUnflippedMasterSets.mat';
save(AllSmoothUnflippedCompiledPath, 'CombinedMean', 'CombinedCounts', 'Slopes', 'Intercepts', 'Fits', 'SubsetsIncluded',...
    'Ts', 'Reps', 'CTstrings', 'SubsetsIncluded');
