function CheungMaFigure1D_BgdSubVersion(AllCompiledEmbryos)
%%
APbins = 0:0.025:1;
...
for exp_index = 1:15
    ...
    for idx = 1:length(chList)
        ...
        for time_index = 1:length(times_to_plot)
            ...
            x = x(TF);
            y = CompiledEmbryos.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.AllProfiles(TF,:,ch_index, master_index);
            ...
            yf = CompiledEmbryos.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.TestSet.mean(matchidx,:,ch_index, master_index);
...
for exp_index = 1:15
    ...
    for idx = 1:length(chList)
        ...
        for time_index = 1:5
            x = CompiledEmbryos.DubuisEmbryoTimes;
            if time_index == 1
                y = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.MeanProfile{ch_index, master_index};
                y_sd = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.ProfileSD{ch_index, master_index};
            elseif time_index == 2
                y = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.MeanProfileP50{ch_index, master_index};
                y_sd = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.ProfileSDP50{ch_index, master_index};
            elseif time_index == 3
                y = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.MeanProfileP75{ch_index, master_index};
                y_sd = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.ProfileSDP75{ch_index, master_index};
            
            elseif time_index == 4
                y = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.MeanProfileP90{ch_index, master_index};
                y_sd = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.ProfileSDP90{ch_index, master_index};
            
            elseif time_index == 5
                y = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.MeanProfileP25toP75{ch_index, master_index};
                y_sd = CompiledEmbryos.NC13.BgdSubNormalizedUnivScaledProfiles.SlideRescaledDorsalAvgAPProfiles.ControlScaling.ProfileSDP25toP75{ch_index, master_index};
...
%                     'LineWidth', 3.0);    
            ...
            if ~isdir([AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedMeanTestProfiles'])
                mkdir([AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedMeanTestProfiles'])
            end
            if rep_type_index < 3
            outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedMeanTestProfiles', filesep,...
...
%                     'LineWidth', 3.0);    
            ...
            DeltaFCAx.FontSize = 18;
            if ~isdir([AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedSmoothedTestProfiles'])
                mkdir([AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedSmoothedTestProfiles'])
            end
            if rep_type_index < 3
            outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedSmoothedTestProfiles', filesep,...
                ChannelNames{ch_index}, '_MasterSet',num2str(master_index),'_StainReplicate_', num2str(rep_type_index),'_TimeBin', strrep(num2str(times_to_plot(time_index)), '.', '_'), 'm.png' ];
            else
                 outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedSmoothedTestProfiles', filesep,...
                ChannelNames{ch_index}, '_MasterSet',num2str(master_index),'_FlippedStain_', num2str(rep_type_index),'_TimeBin', strrep(num2str(times_to_plot(time_index)), '.', '_'), 'm.png' ];
 ...
 LegendLabels = {'25.0ºC vs. 25.0ºC', '27.5ºC vs. 25.0ºC', '22.5ºC vs. 25.0ºC', '20.0ºC vs. 25.0ºC', '17.5ºC vs. 25.0ºC'};
temp_plot_order = [4 5 3 2 1];
TimeLabels = {'Mean NC13 Profile', ['Mean of Top 50','%',' NC13 Profiles'], ['Mean of Top 25','%',' NC13 Profiles'], ['Mean of Top 10','%',' NC13 Profiles'], ['Mean of 25-75','%',' NC13 Profiles']};
for idx = 1:2
    ch_index = chList(idx);
    for time_index = 1:5
        for rep_type_index = 1:2
            set_indices = (0:3:12)+rep_type_index;
            PlotMeanProfs = cell(1, 5);
            PlotMeanSDs = cell(1, 5);
            PlotSlopes = NaN(1, 5);
            ...
            xmaxes = NaN(1, 5);
            for idx2 = 1:5
                PlotMeanProfs{idx2} = NC13_MeanProfiles{set_indices(idx2), time_index, idx};
                PlotMeanSDs{idx2} = NC13_SDProfiles{set_indices(idx2), time_index, idx};
                if ~isempty(NC13_MeanProfiles{set_indices(idx2), time_index, idx}+NC13_SDProfiles{set_indices(idx2), time_index, idx}) 
                ymaxes(idx2) = max(NC13_MeanProfiles{set_indices(idx2), time_index, idx}+NC13_SDProfiles{set_indices(idx2), time_index, idx});
                xmaxes(idx2) = max(NC13_MeanProfiles{set_indices(idx2), time_index, idx});
                ymins(idx2) = min(NC13_MeanProfiles{set_indices(idx2), time_index, idx}+NC13_SDProfiles{set_indices(idx2), time_index, idx});
                end
                if idx2 ~= 1
                    dlm = NC13_CrossFitMeanProfiles{set_indices(1), set_indices(idx2), time_index, idx};
                    if ~isempty(dlm)
                    PlotSlopes(idx2) = dlm.Coefficients.Estimate(2);
                    PlotIntercepts(idx2) = dlm.Coefficients.Estimate(1);
                    end
...
%                     'LineWidth', 3.0);    
                ...
                if ~isempty(PlotMeanProfs{1}) & ~isempty( PlotMeanProfs{temp_index})
                 ...
                 plot_handles(temp_index) = errorbar(PlotMeanProfs{1}, PlotMeanProfs{temp_index},PlotMeanSDs{temp_index},...
                     'o', 'MarkerSize', 10,'Color', colorsTemperatures(temp_plot_order(temp_index), :),...
                        ...
                        plot_handles(temp_index) = scatter(PlotMeanProfs{1}, PlotMeanProfs{temp_index},100,...
                           'MarkerFaceColor', colorsTemperatures(temp_plot_order(temp_index), :),...
                                'MarkerEdgeColor', 'k');
                    end
                end
            ...
            DeltaFCAx.XAxis.FontSize = 18;
            if rep_type_index < 3
            title(DeltaFCAx, [ChannelNames{ch_index},' ', TimeLabels{time_index}, ' Replicate ', num2str(rep_type_index)], 'FontSize', 20)
            else
                title(DeltaFCAx, [ChannelNames{ch_index}, ' ', TimeLabels{time_index}, ' Flipped Stain'], 'FontSize', 20)
            end
            
            DeltaFCAx.FontSize = 18;
            if ~isdir([AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'NC13BgdSubNormalizedMeanTestProfiles'])
                mkdir([AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'NC13BgdSubNormalizedMeanTestProfiles'])
            end
            if rep_type_index < 3
            outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'NC13BgdSubNormalizedMeanTestProfiles', filesep,...
                ChannelNames{ch_index}, '_MasterSet',num2str(master_index),'_StainReplicate_', num2str(rep_type_index),'_MeanType', num2str(time_index), '.png' ];
            else
                 outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'NC13BgdSubNormalizedMeanTestProfiles', filesep,...
                ChannelNames{ch_index}, '_MasterSet',num2str(master_index),'_FlippedStain_', num2str(rep_type_index),'_MeanType', num2str(time_index), '.png' ];
            end
            saveas(DeltaFCFixCorrectedFig,outpath2);
...
%                     'LineWidth', 3.0);    
            ...
            outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedMeanTestProfiles', filesep,...
                ChannelNames{ch_index}, '_MasterSet',num2str(master_index),'_Time',strrep(num2str(temps(temp_plot_order(temp_index))), '.', '_'),'_mT', strrep(num2str(times_to_plot(time_index)), '.', '_'), 'C.png' ];
...
for idx = 2
    ...
    for time_index = 1:length(times_to_plot)
        for temp_index = 1:5
            ...
            set_indices = (1:2)+(temp_index-1)*3;
            PlotMeanProfs = cell(1, 5);
            PlotMeanSDs = cell(1, 5);
            PlotSlopes = NaN(1, 5);
            PlotSlopes(1) = 1;
...
%                     'LineWidth', 3.0);    
            ...
            plot_handles = zeros(1, 3);
            for rep_index = 1:3
                if ~isempty(PlotMeanProfs{1}) & ~isempty( PlotMeanProfs{rep_index}) & ~isempty( PlotMeanSDs{rep_index})
                    try
                 plot_handles(rep_index) = errorbar(PlotMeanProfs{1}, PlotMeanProfs{rep_index},PlotMeanSDs{rep_index},...
                     'o', 'MarkerSize', 10,'Color', colorsTemperatures(rep_index, :),...
                               'LineStyle', 'none', 'MarkerFaceColor', colorsTemperatures(rep_index, :),...
            ...
            hold off
            xlabel(['Intensity ',num2str(temps(temp_plot_order(temp_index))),'ºC Replicate 1'], 'FontSize', 18)
            ylabel(['Intensity ',num2str(temps(temp_plot_order(temp_index))),'ºC Replicate 1/Replicate 2'], 'FontSize', 18);
            ylim([0,  plot_ymax])
            xlim([0 plot_xmax])
            subplot_handles = plot_handles;
            SubLegendLabels = LegendLabels;
            ...
            title(DeltaFCAx, [ChannelNames{ch_index},' ', num2str(temps(temp_plot_order(temp_index))),'ºC ',TimeLabels{time_index}], 'FontSize', 20)
            ...
            outpath2 = [AllSetsProfFigPath, filesep, 'CheungMaFigure1D', filesep, 'BgdSubNormalizedMeanTestProfiles', filesep,...
                ChannelNames{ch_index}, '_MasterSet',num2str(master_index),'_',TimeLabels{time_index},'_T', strrep(num2str(temps(temp_plot_order(temp_index))), '.', '_'), 'C.png' ];
...
for exp_index = 1:NumSets
    for exp_index2 = 1:NumSets
        for idx = 1:length(chList)
            ch_index = chList(idx);
            for time_index = 1:5%length(times_to_plot)
