...
for i = 1:NEmbryos
    if CompiledEmbryos.Approved(i) & ~isnan(CompiledEmbryos.PVCoordAs(i,1)) & ~isnan(CompiledEmbryos.PVCoordPs(i,1)) & ~isnan(CompiledEmbryos.PVCoordDs(i,1)) & ~isnan(CompiledEmbryos.PVCoordVs(i,1))
        CompiledEmbryos.APLengths(i) = PixelSize_um*sqrt((CompiledEmbryos.PVCoordAs(i,1)-CompiledEmbryos.PVCoordPs(i,1))^2+...
            (CompiledEmbryos.PVCoordAs(i,2)-CompiledEmbryos.PVCoordPs(i,2))^2);
        APSlope = (CompiledEmbryos.PVCoordAs(i,2)-CompiledEmbryos.PVCoordPs(i,2))/(CompiledEmbryos.PVCoordAs(i,1)-CompiledEmbryos.PVCoordPs(i,1));
        APIntercept = CompiledEmbryos.PVCoordAs(i,2)-APSlope*CompiledEmbryos.PVCoordAs(i,1);
        CompiledEmbryos.DorsalDistances(i) = PixelSize_um*abs(APIntercept+APSlope*CompiledEmbryos.PVCoordDs(i,1)-CompiledEmbryos.PVCoordDs(i,2))/sqrt(APSlope^2+1);
        CompiledEmbryos.VentralDistances(i) = PixelSize_um*abs(APIntercept+APSlope*CompiledEmbryos.PVCoordVs(i,1)-CompiledEmbryos.PVCoordVs(i,2))/sqrt(APSlope^2+1);
...
KeepEmbryos = CompiledEmbryos.Approved & (CompiledEmbryos.Flags == 0) & ~isnan(CompiledEmbryos.DVLengths);
