function CompiledParticles = CompileParticlesForFiltering(varargin)
...
[ CompiledParticles, schnitzcells, Ellipses, Particles] = ...
...
save([DropboxFolder, filesep, Prefix, filesep, 'Particles.mat'], 'Particles', '-append');
