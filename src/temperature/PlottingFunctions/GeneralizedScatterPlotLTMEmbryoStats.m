...
if ~SkipParamsVsTemp
    ...
    for SetIndex =1:NumSets
        ...
        prof{SetIndex} = plot([0], [0], MarkerStyles{marker_idx},...
    ...
    if IncludeLogPlots
        ...
        for SetIndex =1:NumSets
            ...
            prof2{SetIndex} = plot([0], [0], MarkerStyles{marker_idx},...
                'MarkerEdgeColor', colors(temp_idx,:),'MarkerFaceColor', colors(temp_idx,:),...
                'linestyle', 'none');
    ...
    for nc_idx=1:length(this.IncludedNCs)
        ...
        if IncludeLogPlots
            ...
            for SetIndex = 1:NumSets
                ...
                legend_profs{SetIndex} = plot([0], [0], MarkerStyles{marker_idx},...
                    'MarkerEdgeColor', colors(temp_idx,:),'MarkerFaceColor', colors(temp_idx,:),...
                    'linestyle', 'none');
                hold on
    ...
    for nc_idx=1:length(ValidNCIndices)
        ...
        for SetIndex = 1:NumSets
            ...
            if isnan(AllNCParams(SetIndex))
                ...
                prof{nc_idx,SetIndex} = plot([0], [0], MarkerStyles{marker_idx},...
                    'MarkerEdgeColor', colors(temp_idx,:),'MarkerFaceColor', colors(temp_idx,:),...
                    'linestyle', 'none');
                ...
                prof{nc_idx,SetIndex} = plot([AllNCTemperatures(SetIndex)],...
                    [AllNCParams(SetIndex)], MarkerStyles{marker_idx},...
                    'MarkerEdgeColor', colors(temp_idx,:),'MarkerFaceColor', colors(temp_idx,:),...
                    'linestyle', 'none');
