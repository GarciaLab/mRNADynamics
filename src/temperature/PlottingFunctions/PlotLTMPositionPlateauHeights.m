function PlotLTMPositionPlateauHeights(this, outdir, varargin)
%%
...
[~, APMaxPositions ] = max(InitiationRates.*ElongationTimes, [], 2);
APMaxPositions = squeeze(APMaxPositions);
APMaxPositions(APMaxPositions == 1) = NaN;
PlottedParams = (APMaxPositions-1)*APResolution;

ylab = 'Fraction of Embryo Length for Fitted Max. Spot Fluo.';
OutputString = 'PositionPlateauHeights';
