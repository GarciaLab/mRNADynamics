...
for nc_idx=1:length(this.IncludedNCs)
    ...
    for t_idx=1:length(temperatures)
        ...
        title(FrameProfAx, {'',...
            ['T = ', num2str(temperatures(t_idx)), '°C, Nuclear Cycle ',num2str(NC),', Fraction Embryo Length: ',num2str(-1) ]})
        ...
        for i = 1:length(APbins)
            ...
            if exist('PlotTitle', 'var')
                title(FrameProfAx, {PlotTitle,...
                    ['T = ', num2str(temperatures(t_idx)), '°C, Nuclear Cycle ',num2str(NC),', Fraction Embryo Length: ',num2str(APbins(i)) ]})
                
                
            else
                title(FrameProfAx, ['T = ', num2str(temperatures(t_idx)), '°C, Nuclear Cycle ',num2str(NC),', Fraction Embryo Length: ',num2str(APbins(i)) ])
