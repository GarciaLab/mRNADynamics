function this = FitTrapezoidsForPerNucleusMS2Traces(this, TempIndex, NC, APindex, TraceType)

alpha = this.alpha;

[MeanTrace, StdErrorTrace, NCTimes] = GetSpecifiedPerNucleusTracesForFitting(this, TempIndex, NC, APindex, TraceType);
...
if length(MeanTrace) >= max([this.MinimumTimePoints 5])
    ...
    if ~isempty(PositiveFitIncludedIndices) & ~isempty(NegativeFitIncludedIndices) & (NC < 14)
        ...
        if EndIndex-StartIndex+1 >= max([this.MinimumTimePoints 5])
            ...
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, f, [], [],...
                TempIndex, NC, APindex, TraceType, 'Fits');
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, pos_slope, se_pos_slope, ci_slope,...
                TempIndex, NC, APindex, TraceType, 'MeanInitiationRates');
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, pos_xintercept, se_pos_xintercept, NaN(1,2),...
                TempIndex, NC, APindex, TraceType, 'TimeOns');
            
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, neg_slope, se_neg_slope, ci_neg_slope,...
                TempIndex, NC, APindex, TraceType, 'UnloadingRates');
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, t_elongation, se_t_elongation, NaN(1,2),...
                TempIndex, NC, APindex, TraceType, 'ElongationTimes');
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, t_off, se_t_off, ci_t_off,...
                TempIndex, NC, APindex, TraceType, 'TimeOffs');
            this = SetSpecifiedTrapezoidPerNucleusFitParameters(this, gof.rsquare, [], [],...
