function this = FitTrapezoidsForTbinnedPerNucleusMS2Traces(this, TempIndex, NC, APindex, TraceType)

alpha = this.alpha;

[MeanTrace, StdErrorTrace, NCTimes] = GetSpecifiedTracesForTbinnedPerNucleusFitting(this, TempIndex, NC, APindex, TraceType);
...
if length(MeanTrace) >= max([this.MinimumTimePoints 5])
    ...
    if ~isempty(PositiveFitIncludedIndices) & ~isempty(NegativeFitIncludedIndices) & (NC < 14)
        ...
        if EndIndex-StartIndex+1 >= max([this.MinimumTimePoints 5])
            ...
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, f, [], [],...
                TempIndex, NC, APindex, TraceType, 'Fits');
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, pos_slope, se_pos_slope, ci_slope,...
                TempIndex, NC, APindex, TraceType, 'MeanInitiationRates');
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, pos_xintercept, se_pos_xintercept, NaN(1,2),...
                TempIndex, NC, APindex, TraceType, 'TimeOns');
            
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, neg_slope, se_neg_slope, ci_neg_slope,...
                TempIndex, NC, APindex, TraceType, 'UnloadingRates');
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, t_elongation, se_t_elongation, NaN(1,2),...
                TempIndex, NC, APindex, TraceType, 'ElongationTimes');
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, t_off, se_t_off, ci_t_off,...
                TempIndex, NC, APindex, TraceType, 'TimeOffs');
            this = SetSpecifiedTrapezoidTbinnedPerNucleusFitParameters(this, gof.rsquare, [], [],...
                TempIndex, NC, APindex, TraceType, 'R2s');
        end
        %end
