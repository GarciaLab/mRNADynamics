function [NCAPtrace, StdErrorTrace, NCTimes] = GetSpecifiedTracesForTbinnedPerNucleusFitting(this, TempIndex, NC,APindex, TraceType)
% author: G. Martini
...
MeanProfileTraces = this.BinnedMeanProfiles.([traceName, 'CycleNuclearMeanTraces'])(:,APindex,NC-8,TempIndex).';
