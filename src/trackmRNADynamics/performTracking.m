function [Particles, SpotFilter] = performTracking(Particles, scurrentChannelitzcells, NCh, ...
    Spots, app, SpotFilter, PreProcPath, Prefix, UseHistone, ParticlesFig, ...
    SpotsChannel, NucleiFig, particlesAxes, nucAxes, Ellipses, PixelSize, ...
    SearchRadius, ExperimentType, FrameInfo, retrack, displayFigures)
