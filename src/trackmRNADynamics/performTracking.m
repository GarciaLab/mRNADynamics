...
Particles = ParticleTrackingKalman(Spots, liveExperiment, ...
                                      useHistone, retrack, displayFigures);

% tic
% disp('Performing intitial particle linking...')
% [RawParticles, SpotFilter, ParticleStitchInfo, ReviewedParticlesFull, FrameInfo] = ...
%                 track01ParticleProximity(...
%                 FrameInfo, Spots, schnitzCells, ...
...
% [ParticlesFull, ParticleStitchInfo, SpotFilter] = track04StitchTracks(...
%   ParticlesFull, SpotFilter, ReviewedParticlesFull, ParticleStitchInfo, Prefix,...
%                                 useHistone, retrack, displayFigures);
% toc 
% 
