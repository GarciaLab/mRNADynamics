function [RawParticles, globalModelStruct] = track02TrainGHMM(...
          RawParticles, globalModelStruct, displayFigures)
  ...
  rerunFlag = ~isempty(globalModelStruct);
    ...
    if ~isempty(longIDVec)
      ...
      if ~rerunFlag
        ...
        for v = 1:size(dataCell,2)
          ...
          [mu0, Sigma0] = mixgauss_init(NumStates*NumMixtures, dataCell{initID,v}, CovarianceType);
          ...
          [globalModelStruct(v).LL, globalModelStruct(v).Prior,globalModelStruct(v).Transmat, ...
            globalModelStruct(v).Mu, globalModelStruct(v).Sigma, globalModelStruct(v).Mixmat] = ...
              mhmm_em(dataCell(longIDVec,v), prior0, transmat0, mu0, Sigma0, mixmat0, ...
