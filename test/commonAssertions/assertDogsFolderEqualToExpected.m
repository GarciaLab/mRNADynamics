...
function assertDogsFolderEqualToExpected(testCase,...
    processedDataExperimentPath, testPath, expectedDataSubFolder)

  dogsPath = [processedDataExperimentPath, filesep, 'dogs'];
  
  expectedDataFolder = [testPath, filesep, expectedDataSubFolder,...
      filesep, 'ProcessedData',...
